...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
        case baron:
            return baronCase (state, choice1);
        
        case minion:
            return minionCase (state, handPos, choice1, choice2);
            
        case ambassador:
            return ambassadorCase (state, handPos, choice1, choice2);
        
        case tribute:
            return tributeCase (state, tributeRevealedCards);
            
        case mine:
            return mineCase (state, handPos, choice1, choice2);
...
int baronCase (struct gameState* state, int choice1){
    int currentPlayer = whoseTurn(state);
...
void baronEstateFunc (struct gameState* state){
    int currentPlayer = whoseTurn(state);
...
int minionCase (struct gameState* state, int handPos, int choice1, int choice2){
    int i;
    int j;
    int currentPlayer = whoseTurn(state);
    //-1 action
...
int ambassadorCase (struct gameState* state, int handPos, int choice1, int choice2){
    int i;
    int j = 0; //used to check if the player has enough cards to discard
    int currentPlayer = whoseTurn(state);
...
int tributeCase (struct gameState* state, int* tributeRevealedCards){
    int i;
    int j;
    int currentPlayer = whoseTurn(state);
    int nextPlayer = currentPlayer + 1;
...
int mineCase (struct gameState* state, int handPos, int choice1, int choice2){
    int i;
    int currentPlayer = whoseTurn(state);
    int j = state->hand[currentPlayer][choice2]; //Stored card we will trash
